...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'perfil_idperfil'); ?>
		<?php echo $form->textField($model,'perfil_idperfil',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'perfil_idperfil'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'password_2'); ?>
		<?php echo $form->textField($model,'password_2',array('size'=>60,'maxlength'=>250)); ?>
